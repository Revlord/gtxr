...
import { SpatialContainer, useGaze } from "@webspatial/react-sdk";
...
const AboutUs = () => {
    ...
    return (
        <SpatialContainer>
            <div className="relative w-full min-h-[calc(100vh)] h-fit flex bg-transparent">
                <div className="w-full h-auto flex-grow m-4 my-8 md:m-8 relative flex flex-col items-center text-center py-0 sm:py-16">
                    ...
                    <div className="flex flex-wrap max-w-[1440px] gap-5 w-full mt-8 sm:mt-16 lg:mt-24 justify-center">
                        {[0,1,2,3,4,5].map(variant => (
                            <div key={variant} style={{ transform: isGazed ? "scale(1.07)" : "scale(1)", transition: "transform 0.2s" }}>
                                <AboutUsCard
                                    title={["Workshops","Project Teams","Project Pitches","Social Events","Research","Hackathons"][variant]}
                                    content={["Seminars to learn about the latest tech, tools, and techniques in XR.","Shared projects to apply XR knowledge and skills to real-world problems.","Member-driven ideas for collaborative projects to work on with teams.","Social events and many networking opportunities to connect and socialize.","We actively engage in conducting XR research under professors","ImmerseGT, our annual XR hackathon held in the spring semester."][variant]}
                                    variant={variant}
                                />
                            </div>
                        ))}
                    ...
                    <div className="mt-8 sm:mt-16 flex gap-8 flex-col lg:flex-row items-center">
                        <img src={Club1.src} alt="Stock Image 1" className="w-full lg:w-[60%] max-w-7xl h-auto rounded-[3rem] transform transition duration-300 hover:scale-[110%] shadow-2xl" />
                    ...
                    <div className="mt-16 flex gap-8 items-center flex-col-reverse lg:flex-row">
                        ...
                        <img src={Club2.src} alt="Stock Image 2" className="w-full lg:w-[60%] max-w-7xl h-auto rounded-[3rem] transform transition duration-300 hover:scale-[110%] shadow-2xl" />
                    </div>
                    ...
                    <div className="w-full flex flex-col lg:flex-row justify-center items-center gap-4 sm:gap-12 md:gap-16 mt-8 sm:mt-12 lg:mt-16">
                        ...
                        >
                            <div className="flex basis-full flex-col p-4 tracking-tight text-slate-100/50 sm:basis-1/2 w-[20rem] sm:w-[30rem] h-fit">
                                ...
                                <img src={ImmerseGT.src} alt="ImmerseGT" className="w-full h-auto rounded-lg mt-4 shadow-2xl" />
                            </div>
                        </PinContainer>
                    </div>
                </div>
