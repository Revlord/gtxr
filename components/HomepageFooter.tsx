    ...
    return (
        <footer className="w-[calc(100%-64px)] mx-auto px-8 sm:px-12 lg:px-16 py-16 text-white my-8 rounded-[3rem] relative footer-gradient overflow-hidden">
            <div className="max-w-3xl mx-auto">
                ...
                <p className="text-center text-zinc-400 mt-12 pt-8 border-t border-zinc-700 text-sm">Website designed and developed by <Link href={'https://github.com/AlexT101'}>Alex Thummalapalli </Link>and <Link href={'https://github.com/Revlord'}>Revanth Reddy</Link></p>
                </div>
